...
if uploaded_file:
    ...
    if extra_columns:
        st.warning("Existem colunas excedentes que não estão na ordem padrão. Elas serão adicionadas ao final:")
    ...
    if st.button("Salvar Arquivo"):
        ...
        # Salvar arquivo com as colunas excedentes em fonte vermelha
        ...
        start_col = len(DEFAULT_COLUMNS) + 1
